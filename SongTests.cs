...
public class SongTests
{
    ...
    public void Test_AddAndListSongs_ReturnsFilteredSongs_WhenWantedListIsSpecific()
    {
        ...
        string typeOfTheSong = "Rock";

        // Act
        string result = this._song.AddAndListSongs(songs, typeOfTheSong );
        // Assert
        Assert.That(result, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Test_AddAndListSongs_ReturnsEmptyString_WhenNoSongsGiven()
    {
        //Arrange
        string[] songs = { };
        //Act
