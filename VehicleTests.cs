...
public class VehicleTests
{
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsStoredCatalogue_WhenOnlyCarsAreGiven()
    {
        //Arrange
        string[] input = {"Car/Ford/Focus/120", "Car/Toyota/Camry/150"};
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsStoredCatalogue_WhenOnlyTrucksAreGiven()
    {
        //Arrange
        string[] input = {"Truck/Volvo/VNL/500"};
